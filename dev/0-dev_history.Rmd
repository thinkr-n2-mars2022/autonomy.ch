...
fusen::fill_description(
  ...
  fields = list(
    ...
    `Authors@R` = c(
      person("Christine", "Hoogland", email = "christine.hoogland@finddx.org", role = c("aut", "cre"), comment = c(ORCID = "0000-0002-7341-1551")),
      person(given = "ThinkR", role = "cph")
    )
  )
)
# Define License with use_*_license()
usethis::use_mit_license("Christine Hoogland")
```
